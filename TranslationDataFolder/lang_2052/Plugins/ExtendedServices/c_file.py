...
DATA: TranslationDataType = [
    ...
    (f"{CONST_PATH_PLUGIN_EXTENDEDSERVICES}/trigger.c", "utf-8", {
        ...
        "Group policy change": "组策略更改",
        "Group policy change: Machine": "组策略更改: 本机",
        "Group policy change: User": "组策略更改: 用户",
        "Group policy change: Unknown": "组策略更改: 未知",
        "Network endpoint: RPC interface": "网络端点: RPC 接口",
        "Network endpoint: Named pipe": "网络端点: 命名管道",
        "Network endpoint: Unknown": "网络端点: 未知",
        "Trigger": "触发器",
        "Action": "操作",
        "Device interface arrival: ": "设备接口到达: ",
        "IP address availability: ": "IP 地址可用性: ",
        ...
        "(binary data)": "(二进制数据)",
        "(level) %u": "(等级) %u",
        "(keyword any) 0x%I64x": "(任何关键词) 0x%I64x",
        "(keyword all) 0x%I64x": "(所有关键词) 0x%I64x",
        "(unknown type)": "(未知类型)",
        "Data": "数据",
        "Unable to find the ETW publisher GUID.": "找不到 ETW 发布者 GUID。",
        "The custom subtype is invalid.": "自定义子类型无效。",
        r"Please ensure that the string is a valid GUID: \"{x-x-x-x-x}\".": r"请确保字符串是有效的 GUID: \"{x-x-x-x-x}\"。",
