         ...
         '''static CONST PH_KEY_VALUE_PAIR PhProtectedTypeStrings[] =
{
    ...
    (f"{CONST_PATH_SYSTEM_INFORMER_SRC}/options.c", "utf-8", {
        ...
        "Use": "使用",
        # -----------------------------------------------------------------------------
        # todo: Null Point Reference Exception
    ...
    (f"{CONST_PATH_SYSTEM_INFORMER_SRC}/tokprp.c", "utf-8", {
        ...
        ('PhAddIListViewGroup(context->ListView, listViewGroupIndex++, L"Profile"', 'PhAddIListViewGroup(context->ListView, listViewGroupIndex++, L"资料"'),
        ('PhAddIListViewGroup(context->ListView, 4, L"Profile"', 'PhAddIListViewGroup(context->ListView, 4, L"资料"'),
        ...
        ('PhAddListViewGroup(context->ListViewHandle, listViewGroupIndex++, L"Profile"',
         'PhAddListViewGroup(context->ListViewHandle, listViewGroupIndex++, L"资料"'),
        ('PhAddListViewGroup(context->ListViewHandle, 4, L"Profile"',
         'PhAddListViewGroup(context->ListViewHandle, 4, L"资料"'),
    ]),
